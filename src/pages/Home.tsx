...
export default function Home() {
      ...
      <section className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              {/* Decorative badge */}
              <div className="absolute -top-4 -left-4 z-20 bg-[#0c71c3] text-white px-4 py-2 rounded-full text-sm font-bold shadow-lg shadow-[#0c71c3]/30">
            ...
            >
              <motion.div variants={fadeInUp}>
                <span className="inline-block text-[#0c71c3] font-bold text-xs sm:text-sm uppercase tracking-[0.2em] mb-3 bg-[#0c71c3]/10 px-4 py-1.5 rounded-full border border-[#0c71c3]/20">
                  About Me
                </span>
              ...
              <motion.div variants={fadeInUp}>
                <Link
                  to="/about"
                  className="group inline-flex items-center gap-3 px-8 py-4 bg-[#0c71c3] hover:bg-[#0a5fa3] text-white font-bold rounded-full shadow-lg shadow-[#0c71c3]/30 hover:shadow-[#0c71c3]/50 hover:-translate-y-0.5 transition-all duration-300"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.span
              ...
              className="inline-block text-[#0c71c3] font-bold text-xs uppercase tracking-[0.2em] mb-2 bg-[#0c71c3]/10 px-4 py-1 rounded-full border border-[#0c71c3]/20"
            >
              Career Highlights
            </motion.span>
  ...
  {experience.slice(0, 4).map((job: any, index: number) => (
    <motion.div
      ...
      className="group relative bg-white p-5 sm:p-6 rounded-xl border border-gray-200 hover:border-[#0c71c3]/30 shadow-md hover:shadow-[0_4px_25px_rgba(12,113,195,0.1)] transition-all duration-300 hover:-translate-y-0.5"
    >
        ...
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div className="space-y-1.5 flex-1 min-w-0">
            ...
            <div className="flex flex-wrap items-baseline gap-2">
              <h3 className="text-base sm:text-lg font-bold tracking-tight text-gray-900 group-hover:text-[#0c71c3] transition-colors duration-300">
                {job.title}
              </h3>
  ...
  >
    <Link
      to="/about#experience"
      className="group inline-flex items-center gap-2 px-6 py-2.5 bg-[#0c71c3] hover:bg-[#0a5fa3] text-white font-medium text-sm rounded-full shadow-md shadow-[#0c71c3]/25 hover:shadow-[#0c71c3]/40 transition-all duration-300 hover:-translate-y-0.5"
    >
      ...
      {/* <section className="py-32 bg-white relative overflow-hidden">
        <div className="absolute top-0 left-0 w-[600px] h-[600px] bg-[#f57507]/5 rounded-full blur-3xl opacity-30" />
        <div className="absolute bottom-0 right-0 w-[700px] h-[700px] bg-[#0c71c3]/5 rounded-full blur-3xl opacity-30" />
          ...
          >
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 mb-20">
              ...
              <motion.div variants={fadeInUp}>
                <Link
                  to="/projects"
                  className="hidden md:inline-flex items-center gap-2 px-8 py-4 bg-[#0c71c3] hover:bg-[#0a5fa3] text-white font-bold rounded-full shadow-lg shadow-[#0c71c3]/30 hover:shadow-[#0c71c3]/50 hover:-translate-y-0.5 transition-all duration-300"
                >
                  View All Projects
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {projects.slice(0, 3).map((project) => (
                <motion.div
                  ...
                  variants={fadeInUp}
                  whileHover={{ y: -10 }}
                  className="group rounded-3xl overflow-hidden bg-white border border-gray-200 shadow-lg hover:shadow-2xl transition-all duration-500 hover:border-[#0c71c3]/30"
                >
                  <div className="relative h-64 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-r from-[#0c71c3]/20 to-[#f57507]/20 mix-blend-overlay opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  </div>
                  <div className="p-8 relative">
                    <div className="absolute -top-10 right-8 w-14 h-14 bg-gradient-to-r from-[#0c71c3] to-[#f57507] rounded-2xl flex items-center justify-center text-white shadow-lg shadow-[#0c71c3]/30 transform group-hover:-translate-y-2 transition-transform duration-300">
                      <BookOpen className="w-6 h-6" />
                    </div>
                    <h3 className="text-2xl font-bold text-gray-900 group-hover:text-[#0c71c3] transition-colors pr-12">
                      {project.title}
                    </h3>
                    ...
                    <div className="mt-8">
                      <span className="inline-flex items-center gap-2 text-sm font-bold text-[#0c71c3] uppercase tracking-wider group-hover:text-[#0a5fa3] transition-colors cursor-pointer">
                        Explore Project
            ...
            >
              <Link
                to="/projects"
                className="inline-flex items-center gap-2 px-8 py-4 bg-[#0c71c3] hover:bg-[#0a5fa3] text-white font-bold rounded-full shadow-lg shadow-[#0c71c3]/30 hover:shadow-[#0c71c3]/50 transition-all duration-300"
              >
                View All Projects
                <ArrowRight className="w-4 h-4" />
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-20">
              <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-r from-[#0c71c3]/10 to-[#f57507]/10 mb-6">
                <Quote className="w-8 h-8 text-[#0c71c3]" />
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {testimonials.slice(0, 2).map((t) => (
                <motion.div
                  key={t.id}
                  variants={fadeInUp}
                  className="bg-white rounded-[2rem] p-10 md:p-12 shadow-2xl shadow-gray-200/50 border border-gray-100 relative group hover:shadow-[#0c71c3]/10 transition-all duration-500"
                >
                  <Quote className="absolute top-10 right-10 w-16 h-16 text-gray-50 transition-colors duration-500 group-hover:text-[#0c71c3]/10" />
                  <div className="relative z-10">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-[#0c71c3] font-medium">{t.role}</p>
                      </div>
                    </div>
                  </div>
                </motion.div>
      ...
      <section className="py-20 relative overflow-hidden bg-gradient-to-br from-[#0c71c3] to-[#0a5fa3]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                to="/contact"
                className="inline-flex items-center gap-3 px-10 py-4 bg-white text-[#0c71c3] font-bold rounded-full shadow-lg shadow-black/20 hover:shadow-black/40 hover:-translate-y-0.5 transition-all duration-300"
              >
                Get In Touch
                <ArrowRight className="w-5 h-5" />
              </Link>
              {/* <Link
                to="/projects"
                className="inline-flex items-center gap-3 px-10 py-4 bg-white/10 hover:bg-white/20 text-white font-semibold rounded-full border border-white/30 hover:border-white/50 transition-all duration-300 backdrop-blur-sm"
              >
                View My Work
              </Link> */}
            </div>
