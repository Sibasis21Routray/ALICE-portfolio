...
export default function HeroSection() {
  ...
  return (
    <section className="relative min-h-[100svh] w-full flex items-center pt-32 pb-20 bg-[#030712] text-white overflow-hidden selection:bg-[#0c71c3]/30">
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* <div className="absolute inset-0 bg-gradient-to-r from-[#030712]/90 via-[#030712]/70 to-[#030712]/40" /> */}
      </div>
          ...
          >
            ...
            <motion.div variants={fadeInUp} className="inline-flex items-center w-full sm:w-auto">
              <span className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/[0.03] backdrop-blur-xl text-white    text-[10px] sm:text-xs font-semibold tracking-widest uppercase rounded-full border border-white/[0.08] shadow-2xl shadow-black/40">
                {/* <Network className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-[#0c71c3] drop-shadow-[0_0_8px_rgba(12,113,195,0.5)]" /> */}
...
>
  Download CV
            ...
            >
              <div>
                <p className="text-xl sm:text-2xl md:text-3xl font-black text-white">25+</p>
              ...
              <div>
                <p className="text-xl sm:text-2xl md:text-3xl font-black text-white">50+</p>
                <p className="text-[8px] sm:text-[10px] font-bold text-[#0c71c3] uppercase tracking-widest mt-0.5 sm:mt-1">Patents</p>
              </div>
              <div className="w-px h-6 sm:h-8 bg-white/10" />
              <div>
                <p className="text-xl sm:text-2xl md:text-3xl font-black text-white">250+</p>
